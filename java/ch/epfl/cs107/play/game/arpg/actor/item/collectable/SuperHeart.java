...
public class SuperHeart extends ARPGCollectableAreaEntity {

    private Animation animation;
    private static final int ANIMATION_DURATION = 4;

    /// The amount of Health Points the heart gives when collected by the Player
    private static final float HP = 10f;
     ...
     */
    protected SuperHeart(Area area, Orientation orientation, DiscreteCoordinates position) {
